...
Environment::Environment() {
	...
	/////
	l = new TreeNodeList();
	Tree *n1a = new Tree(1, 0, -.6, TREE_CONE);
	...
	Tree *n5b = new Tree(1.4, 0, -1.5, TREE_CONE);
	...
	Tree *n5g = new Tree(1.4, 0, -2.8, TREE_CONE);
	...
	Tree *n6e = new Tree(.60, 0, -2.4, TREE_CONE);
	...
	Tree *n7g = new Tree(1.8, 0, -2.8, TREE_CONE);
	...
	Tree *n9g = new Tree(2.6, 0, -2.8, TREE_CONE);
	...
	Tree *nn2e = new Tree(-.6 - 1, 0, 1 + 1.2, TREE_CONE);
