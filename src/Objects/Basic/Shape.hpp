...
public:
	...
	virtual void rotate_origin(GLfloat rx, GLfloat ry, GLfloat rz,
			GLfloat angle); // to rotate the origin of MC and keep the vector changed
	void rotate_relative(double x0, double y0, double z0, double rx, double ry,
